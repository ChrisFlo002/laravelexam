...
Route::middleware(['auth', 'governor', 'role:governor'])->group(function () {
    ...
    Route::get('/electors', [GovernorController::class, 'showGovernorElectors']);
    Route::get('/senators', [GovernorController::class, 'showGovernorSenators']);
    Route::get('/parlementaire', [GovernorController::class, 'showGovernorParlementaire']);
});
