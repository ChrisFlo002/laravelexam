    ...
    <div class="d-flex">
        ...
        <nav class="bg-primary text-white p-3 sidebar" style="height: 100vh;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item" style="margin-bottom: 10px; font-family: Arial, sans-serif; font-size: 20px;">
                    <a href="/governor/electors/{id}" class="nav-link text-white d-flex align-items-center">
                        <i class="fas fa-users me-2"></i>Elector
                    </a>
                </li>

                <li class="nav-item" style="margin-bottom: 10px; font-family: Arial, sans-serif; font-size: 20px;">
                    <a href="/governor/parle" class="nav-link text-white d-flex align-items-center">
                        <i class="fas fa-file-alt me-2"></i>Parlementaire
                    </a>
                </li>
                <li class="nav-item" style="margin-bottom: 10px; font-family: Arial, sans-serif; font-size: 20px;">
                    <a href="/governor/senator" class="nav-link text-white d-flex align-items-center">
                        <i class="fas fa-chart-bar me-2"></i>Senator
                    </a>
                </li>
                <li class="nav-item" style="margin-bottom: 10px; font-family: Arial, sans-serif; font-size: 20px;">
                    <a href="/governor/flag" class="nav-link text-white d-flex align-items-center">
                ...
                <li class="nav-item">
                    <form method="POST" action="/logout">
                        ...
                        <button type="submit" class="nav-link text-white d-flex align-items-center"
                            style="font-family: Arial, sans-serif; font-size: 20px; margin-top: 30px;">
